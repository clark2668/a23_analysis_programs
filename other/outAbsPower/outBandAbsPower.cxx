...
{ //start main
  ...
  */
    ...
    if(isBadRun(3, run_num, BadRunList)) return -1;
  	if(isSoftwareDominatedRun("/users/PAS0654/osu0673/A23_analysis_new2/AraRoot/analysis/a23_analysis_tools", 3, run_num)) return -1;
    if(hasUntaggedCalpul("/users/PAS0654/osu0673/A23_analysis_new2/AraRoot/analysis/a23_analysis_tools", station, config, run_num)) return -1;

    char rootName[100];
    sprintf(rootName,"./c%i_run%i.root", config, run_num);
