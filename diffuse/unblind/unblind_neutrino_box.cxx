...
int main(int argc, char **argv)
{
	...
	vector<int> toRunOver;
	// if(config==1){
	// 	toRunOver.push_back(2583);
	// 	toRunOver.push_back(3041);
	// 	toRunOver.push_back(3439);
	// }
	// if(config==2){
	// 	toRunOver.push_back(1595);
	// }
	// if(config==3){
	// 	toRunOver.push_back(3689);
	// 	toRunOver.push_back(3778);
	// 	toRunOver.push_back(3874);
	// 	toRunOver.push_back(3916);
	// }
	// if(config==4){
	// 	toRunOver.push_back(4528);
	// 	toRunOver.push_back(4812);
	// 	toRunOver.push_back(5366);
	// 	toRunOver.push_back(5539);
	// 	toRunOver.push_back(6290);
	// 	toRunOver.push_back(6345);
	// }
	if(config==5){
		// toRunOver.push_back(6595);
		// toRunOver.push_back(6617);
		toRunOver.push_back(6842);
		// toRunOver.push_back(7307);
		// toRunOver.push_back(7536);
	}

	for(int i=0; i<toRunOver.size(); i++){
		sprintf(the_data,"/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/ValsForCuts/A%d/c%d/cutvals_drop_FiltSurface_snrbins_0_0_wfrmsvals_-1.3_-1.4_run_%d.root",station,config,toRunOver[i]);
...
int PlotThisEvent(int station, int runNum, int event, int problempol){
	...
	if(doMapsAtAll){
		...
		if(print_maps){
			...
			sprintf(save_temp_title,"/users/PAS0654/osu0673/A23_analysis_new2/results/unblind/neutrino_box/passing_events/A%d_Run%d_Ev%d_Maps_300m_Exclude5and13.png",station,runNum,event);
			cMaps->SaveAs(save_temp_title);
			delete cMaps;
		}
