...
int main(int argc, char **argv)
{
	...
	if(do_reco_snrweighted_newnormalization_select){
		...
		// sprintf(filter_file_name,"%s/../100pct_try2/ProcessedFile2/A%d/%d/processed_station_%d_run_%d_filter.root",DataDirPath,station,year,station,runNum);
		sprintf(filter_file_name,"/fs/project/PAS0654/ARA_DATA/A23/100pct_try2/ProcessedFile/A%d/%d/processed_station_%d_run_%d_filter.root",station,year,station,runNum);
