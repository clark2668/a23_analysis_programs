...
////
////	Nov 2018
////	updated Nov 2019 for A3
////	the point is to save out the 2D dists and some associated parameter
////	which can then be looped over in the grid optimizer
////////////////////////////////////////////////////////////////////////////////
	...
	// do this inside brackets for scoping power and re-use of identical variable names when it comes time for simulation to happen
	{
		...
		for(int event=0; event<numDataEvents; event++){
			...
			for(int pol=0; pol<2; pol++){
				...
				if(!WFRMS[pol] && !isNewBox && !box300 && !isSurf[0] && !isSurf[1] && !isSurfEvent_top[pol]){
